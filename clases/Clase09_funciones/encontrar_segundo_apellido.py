...
for estudiante in lista_estudiantes:
    if cont == 0:
        apellido_primer_estudiante = encontrar_segundo_apellido(estudiante)
        print("El segundo apellido obtenido del primer estudiante es:", apellido_primer_estudiante)
    if cont>0:
        apellido = encontrar_segundo_apellido(estudiante)
        if apellido == apellido_primer_estudiante:
            cont_repetidos += 1
    cont += 1

print("El segundo apellido del primer estudiante se repite", cont_repetidos, "veces en la lista de estudiantes como segundo apellido")
